...
const baseStyles =
  "inline-flex cursor-pointer items-center gap-[10px] justify-center font-medium rounded-md transition-colors focus:outline-none focus:ring-2 focus:ring-offset-2";
